...
#ifndef GPCR_RQUEUE_H
#define GPCR_RQUEUE_H
...
/**
 * \ingroup gpcr
 * \brief GPCR route request queue
 *
 * Since GPCR is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
public:
