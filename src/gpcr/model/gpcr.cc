...
#define JITTER (Seconds (UniformVariable ().GetValue (-GPCR_MAXJITTER, GPCR_MAXJITTER))) 
#define FIRST_JITTER (Seconds (UniformVariable ().GetValue (0, GPCR_MAXJITTER))) //first Hello can not be in the past, used only on SetIpv4
